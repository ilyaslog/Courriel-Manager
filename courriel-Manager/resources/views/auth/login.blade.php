...
<head>
    ...
    <!-- Custom script to clear form fields on page load -->
    <script>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        <!-- Logo -->
                        <a href="{{route('login')}}" class="card-header pt-4 pb-4 text-center bg-primary">
                            <span class="logo-lg">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('login') }}" id="loginForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="email" type="email" id="email" value="" placeholder="Enter your email">
                                </div>
