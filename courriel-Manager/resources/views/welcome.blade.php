                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#compose-modal">Ajoute un Evenement</button>
                                            </div>
                                            <div id="calendar"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header modal-colored-header bg-primary">
                                            <h4 class="modal-title" id="compose-header-modalLabel">New Event</h4>
                                        ...
                                        <div class="p-1">
                                            ...
                                            <div class="px-3 pb-3">
                                                <button type="button" class="btn btn-primary" id="save-event"
                                                    data-bs-dismiss="modal"><i class="mdi mdi-send me-1"></i> Create
                                                    Event</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('confirm-delete').addEventListener('click', function() {
                if (currentEvent) {
                    currentEvent.remove();
                    events = events.filter(event => event.title !== currentEvent
