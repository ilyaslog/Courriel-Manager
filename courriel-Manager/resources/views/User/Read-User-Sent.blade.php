...
<body class="loading" data-layout-config='{"leftSideBarTheme":"dark"}'>
    <div class="wrapper">
        ...
        @section('content')
            <div class="content">
                <h1>Bonjour {{ Auth::user()->name }}, bienvenue dans vos messages envoyés !</h1>
                                    ...
                                    <div class="email-content">
                                        <div class="email-subject">
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="info">
                                                    <h3 class="m-0 font-14">{{ $courriel->destinataires->name }},
                                                        &lt;{{ $courriel->destinataires->email }}&gt;</h3>
                                            ...
                                            @if ($courriel->courrier)
                                                @php
                                                    $filename = basename($courriel->courrier); // Récupérer le nom de fichier de base
                                                    $extension = pathinfo($filename, PATHINFO_EXTENSION); // Extraire l'extension du fichier
                                                @endphp
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <div class="avatar-sm">
                                                                                <span
                                                                                    ...
                                                                                    <!-- Afficher l'extension en majuscules -->
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col ps-0">
                                                                            ...
                                                                            <!-- Supposant que vous avez la taille du fichier stockée ou pouvez la calculer -->
